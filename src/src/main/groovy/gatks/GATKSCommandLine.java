...
public class GATKSCommandLine extends CommandLineGATK {
    ...
    public void start(String[] argv) {
        try {
            ...
            for(Closure init : this.initializers)
                realizedWalker.addInitializer(init);
    ...
    private void addVCFArg(List<String> args, Object object) {
        ...
        for(String vcf : vcfs) {
            ...
            try {
                ...
                CtField field = new CtField(rodClass, "vcf"+count, annotatedWalker);
